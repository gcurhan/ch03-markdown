...
.syntax--source.syntax--python .syntax--variable.syntax--parameter {
  ...
  <body class='markdown-preview' data-use-github-style><h1 id="exercise-1">Exercise #1</h1>
<blockquote>
<p>"Change your life today. Dont gamble on the future, act now without delay.""- Future</p>
</blockquote></body>
</html>
